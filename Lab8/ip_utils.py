...
def get_network_prefix(ip_cidr: str) -> str:
    """Return the binary network prefix from CIDR notation."""
...
if __name__ == "__main__":
    print(ip_to_binary("192.168.1.1"))      # 11000000101010000000000100000001
    print(get_network_prefix("200.23.16.0/23"))  # 11001000000101110001000